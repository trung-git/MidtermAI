...
Original file is located at
    https://colab.research.google.com/drive/1u4pCvDZmmUHjJ1gFpR6L-CjUVvVkkzmc
"""
...
class Heuristic_Node:
    def __init__(self,node,par = None, h = 0, g = 0):
        self.node = node
        self.par = par
        self.h = h 
        self.g = g
    def display(self):
        print(self.node,self.h,self.h,self.g)
...
def A_Heuristic(start,end,data):
...
if __name__ == "__main__":
    ...
    Romania.show_graph()
    print()
    A_Heuristic("Arad","Bucharest",Romania.G)
